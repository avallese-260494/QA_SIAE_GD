Feature: Compile_Report_With_Mandatory_Field_Validation_Legal_Entity_Flow_ANDROID
  Scenario: Compile_Report_With_Mandatory_Field_Validation_Legal_Entity_Flow_ANDROID
    ...
    And I scroll down until ReportPage.fiscalCodeFieldErrorMandatoryField is displayed
